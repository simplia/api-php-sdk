...
class ProductFieldConfig extends AbstractFieldConfig {
    ...
    public function withBrand(BrandFieldConfig $config): self {
        $this->fields['brand'] = $config;

        return $this;
    }

    public function withSupplier(SupplierFieldConfig $config): self {
